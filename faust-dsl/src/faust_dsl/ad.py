...
from faust_dsl.compose import DspFunc
...
def _process_equation(
    ...
    from faust_dsl._core import Equation
...
def _register_all() -> None:
    ...
    def _jvp_mod(
        ...
        from faust_dsl._primitives import floor_p
        a, b = primals
        da, db = tangents
        out = prim.bind(a, b)
    ...
    from faust_dsl._primitives import faust_expr_p
