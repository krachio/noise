...
from faust_dsl._primitives import control_p
from faust_dsl.compose import DspFunc, get_num_inputs
...
def make_graph(
    ...
    *,
    ...
    from faust_dsl._core import coerce_to_signal as _coerce
...
def transpile(
    ...
    *,
    ...
    Example::
        ...
        from faust_dsl import transpile, control
        from faust_dsl.lib import sine_osc
