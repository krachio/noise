...
class Signal:
    ...
    def __sub__(self, other: SignalLike) -> Signal:
        from faust_dsl._primitives import sub_p
    ...
    def __truediv__(self, other: SignalLike) -> Signal:
        from faust_dsl._primitives import div_p
