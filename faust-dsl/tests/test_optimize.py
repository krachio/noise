...
from faust_dsl._core import ConstParams, Signal
from faust_dsl._optimize import (
    common_subexpression_elimination,
    constant_fold,
    dead_code_elimination,
)
from faust_dsl._primitives import const_p, mem_p
from faust_dsl._dsp import mem
...
def test_constant_fold_removes_equation() -> None:
    ...
    from faust_dsl._core import coerce_to_signal
