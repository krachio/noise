...
use pattern_engine::engine::{Engine, EngineCommand, TimedEvent};
use pattern_engine::ipc;
use pattern_engine::ipc::protocol::ServerMessage;

/// A running pattern-engine kernel for integration tests.
///
