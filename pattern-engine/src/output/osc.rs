//! OSC output sink via [rosc](https://docs.rs/rosc) + UDP.
//!
//! Sends [`Value::Osc`] events as OSC packets.
...
impl OscSink {
    ...
    ///
    /// audio-engine receives the bundle early (up to one lookahead window ahead of
