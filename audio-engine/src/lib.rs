...
//!
//! audio-engine processes audio through a directed acyclic graph of [`DspNode`]s.
...
//! use audio_engine::ir::{GraphIr, NodeInstance, ConnectionIr};
...
//! # Custom node types
//!
//! audio-engine is DSP-agnostic — register your own node types via the
...
//! use audio_engine::ir::types::{NodeTypeDecl, PortDecl, ChannelLayout};
//! use audio_engine::registry::{NodeFactory, NodeRegistry};
//!
//! struct MyNode;
